(define 
        ...
        (:goal (and 
                ...
                ; (= (@ep ("+ b [a] + b [c]") (= (shared_value as) 4)) ep.false)
                ;(= (@ep ("+ b [c]") (= (secret_truth_value as) 8)) ep.true)
                ;(!= (@jp ("b [a] b [c]") (shared_value as)) 9)
                (= (@ep ("+ b [a] + b [c]") (= (shared_value sa) 10)) ep.false)
        ...
        (:ranges
            ...
            (own integer [0,1])
            (sharing integer [0,1])
            (secret_truth_value float [0,10])
            (secret_lyging_value float [0,10])
            (shared_value float [0,10])
        )
