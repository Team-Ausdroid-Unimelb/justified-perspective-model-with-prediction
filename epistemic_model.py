...
class EpistemicModel:
    ...
    def eval_eq(self,eq_query_str, condition, parent_prefix,state_sequence, input_ps):
        ...
        if ep_group_type == EpistemicGroupType.Individual:
            ...
            result = self.eval_eq_single_agent(ep_prefix_str,ep_type,agent_index,rest_eq_str,condition, parent_prefix,state_sequence, input_ps)
            print(result)
    ...
    def eval_eq_single_agent(self,ep_prefix_str,ep_type,agent_index,rest_eq_str,condition:Condition, parent_prefix,state_sequence, input_ps):
        ...
        if ep_type == EpistemicType.Knowledge:
            if rest_eq_str == '':
                ...
                return self.eval_eq(rest_eq_str,condition, os_key_str, input_ps)
